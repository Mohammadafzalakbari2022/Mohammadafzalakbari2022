...
part of 'shop_expense_entity.dart';
...
extension GetShopExpenseEntityCollection on Isar {
  IsarCollection<ShopExpenseEntity> get shopExpenseEntitys => this.collection();
}

const ShopExpenseEntitySchema = CollectionSchema(
  name: r'ShopExpenseEntity',
  id: -4602211349026481949,
  properties: {
  ...
  estimateSize: _shopExpenseEntityEstimateSize,
  serialize: _shopExpenseEntitySerialize,
  deserialize: _shopExpenseEntityDeserialize,
  deserializeProp: _shopExpenseEntityDeserializeProp,
  idName: r'id',
  indexes: {
  ...
  links: {},
  embeddedSchemas: {},
  getId: _shopExpenseEntityGetId,
  getLinks: _shopExpenseEntityGetLinks,
  attach: _shopExpenseEntityAttach,
  version: '3.1.0+1',
);

int _shopExpenseEntityEstimateSize(
  ShopExpenseEntity object,
  List<int> offsets,
...
void _shopExpenseEntitySerialize(
  ShopExpenseEntity object,
  IsarWriter writer,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
...
ShopExpenseEntity _shopExpenseEntityDeserialize(
  Id id,
  IsarReader reader,
  List<int> offsets,
  Map<Type, List<int>> allOffsets,
) {
  final object = ShopExpenseEntity();
  object.amountMinor = reader.readLong(offsets[0]);
  object.category = reader.readLong(offsets[1]);
...
P _shopExpenseEntityDeserializeProp<P>(
  IsarReader reader,
  int propertyId,
  int offset,
  Map<Type, List<int>> allOffsets,
...
Id _shopExpenseEntityGetId(ShopExpenseEntity object) {
  return object.id;
}

List<IsarLinkBase<dynamic>> _shopExpenseEntityGetLinks(
    ShopExpenseEntity object) {
  return [];
}

void _shopExpenseEntityAttach(
    IsarCollection<dynamic> col, Id id, ShopExpenseEntity object) {
  object.id = id;
}

extension ShopExpenseEntityByIndex on IsarCollection<ShopExpenseEntity> {
  Future<ShopExpenseEntity?> getByInternalId(String internalId) {
    return getByIndex(r'internalId', [internalId]);
  }

  ShopExpenseEntity? getByInternalIdSync(String internalId) {
  ...
  Future<Id> putByInternalId(ShopExpenseEntity object) {
    return putByIndex(r'internalId', object);
  }

  Id putByInternalIdSync(ShopExpenseEntity object, {bool saveLinks = true}) {
    return putByIndexSync(r'internalId', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByInternalId(List<ShopExpenseEntity> objects) {
    return putAllByIndex(r'internalId', objects);
  }

  List<Id> putAllByInternalIdSync(List<ShopExpenseEntity> objects,
      {bool saveLinks = true}) {
    return putAllByIndexSync(r'internalId', objects, saveLinks: saveLinks);
  }
}

extension ShopExpenseEntityQueryWhereSort
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QWhere> {
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterWhere> anyId() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(const IdWhereClause.any());
    });
  }

  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterWhere>
      anyCategory() {
    return QueryBuilder.apply(this, (query) {
...
extension ShopExpenseEntityQueryWhere
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QWhereClause> {
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterWhereClause>
      idEqualTo(Id id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterWhereClause>
      categoryNotEqualTo(int category) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
...
extension ShopExpenseEntityQueryFilter
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QFilterCondition> {
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterFilterCondition>
...
extension ShopExpenseEntityQueryObject
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QFilterCondition> {}

extension ShopExpenseEntityQueryLinks
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QFilterCondition> {}

extension ShopExpenseEntityQuerySortBy
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QSortBy> {
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterSortBy>
      sortByAmountMinor() {
    return QueryBuilder.apply(this, (query) {
...
extension ShopExpenseEntityQuerySortThenBy
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QSortThenBy> {
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterSortBy>
      thenByAmountMinor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'amountMinor', Sort.asc);
  ...
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QAfterSortBy> thenById() {
    return QueryBuilder.apply(this, (query) {
...
extension ShopExpenseEntityQueryWhereDistinct
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QDistinct> {
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QDistinct>
  ...
  QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QDistinct> distinctByNote(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension ShopExpenseEntityQueryProperty
    on QueryBuilder<ShopExpenseEntity, ShopExpenseEntity, QQueryProperty> {
  QueryBuilder<ShopExpenseEntity, int, QQueryOperations> idProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'id');
    });
  }

  QueryBuilder<ShopExpenseEntity, int, QQueryOperations> amountMinorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'amountMinor');
    });
  }

  QueryBuilder<ShopExpenseEntity, int, QQueryOperations> categoryProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'category');
    });
  }

  QueryBuilder<ShopExpenseEntity, DateTime, QQueryOperations>
      createdAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShopExpenseEntity, String, QQueryOperations>
      internalIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<ShopExpenseEntity, String, QQueryOperations> noteProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'note');
    });
  }

  QueryBuilder<ShopExpenseEntity, String, QQueryOperations> shopIdProperty() {
    return QueryBuilder.apply(this, (query) {
