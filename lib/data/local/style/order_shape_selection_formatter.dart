...
String _joinTextLabels(List<OrderShapeOptionSnapshotView> options) {
  return options
...
String _joinSizeLabels(List<OrderShapeSizeSnapshotView> options) {
  return options
...
OrderShapeDisplayItem _fromSnapshotFigure(OrderStyleSnapshotFigureView figure) {
  return OrderShapeDisplayItem(
    ...
    detailLabel: _joinTextLabels(figure.textOptions),
    sizeLabel: _joinSizeLabels(figure.sizeOptions),
...
List<OrderShapeDisplayItem> _fromShapeItems(
  ...
  return sortedItems.map((item) {
    ...
    final detailLabel = item.textOptions
        .map((o) => o.labelSnapshot.trim())
        .where((label) => label.isNotEmpty)
        .join(', ');

    final sizeLabel = item.sizeOptions
