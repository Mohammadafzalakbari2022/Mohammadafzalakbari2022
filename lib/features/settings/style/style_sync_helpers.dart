...
void enqueueStyleFigurePresetUpsert(
  WidgetRef ref, {
  required String internalId,
  required String styleFigureInternalId,
  required String name,
  ...
  if (textOptionInternalIds != null) {
    map['text_option_internal_ids'] = textOptionInternalIds;
  }
  if (sizeOptionInternalIds != null) {
    map['size_option_internal_ids'] = sizeOptionInternalIds;
  }
  if (sortOrder != null) map['sort_order'] = sortOrder;
  if (isActive != null) map['is_active'] = isActive;
  _writeSyncTimestamps(map, createdAt: createdAt, updatedAt: updatedAt);
...
void enqueueStyleFigurePresetDelete(
  WidgetRef ref, {
  required String internalId,
}) {
  recordSyncOutboxMutation(
