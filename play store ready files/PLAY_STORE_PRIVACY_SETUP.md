...
(After one-time setup in `docs/GITHUB_PAGES_SETUP.md`. The old path `/docs/privacy-policy.html` redirects here.)

Open that link in your browser to confirm before Play Console submission.
